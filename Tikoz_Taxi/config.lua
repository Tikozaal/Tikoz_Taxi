...
Config.Blip = {
	...
	Pos = vector3(909.16, -159.41, 73.14)
    
}

Config.Pos = {

    Garage = vector3(900.06, -147.48, 75.56),

    SpawnVeh = vector4(901.90, -144.29, 76.62, 329.98),

    Delcar = vector3(901.90, -144.29, 76.62),
...
Listecar = { -- Vous pouvez choisir quel véhicule vous-voulez dans votre garage.
...
Config.Mission = {
    ...
    WaitMin = 1000, -- Temps minimum à attendre pour trouver un client

    WaitMax = 5000, -- Temps maximum à attendre pour trouver un client

    PayeEntreprise = false, -- Si vous vous-voulez que l'entreprise gagne de l'argent pour chaque course effectuer mettez true, sinon mettez false.

    Pourcentage = 80, -- Le pourcentage que l'entreprise va gagner pour chaque course effectuer.

    StartDegat = true, -- Si vous-voulez que le client ne vous paye pas si vous accidentez trop le véhicule.

    DegatMax = 10, -- Dégat maximum que le véhicule peux recevoir avant que le client ne vous paye pas.

    Paye = "bank", -- Vous pouvez être payer en cash = "cash", pour être payer sur le compte en banque = "bank", en argent sale = "sale".

    PrixKm = 30 -- La paye du joueur pour chaque kilomètre parcourue.

}

ListePnj = { -- Vous pouvez choisir quel pnj peux être un client des missions taxi.
    "a_f_m_bevhills_01",
    "a_m_o_ktown_01",
    "a_m_y_busicas_01",
    "s_f_m_sweatshop_01"
...
ClientPosition = { -- Position aléatoire où peuvent spawn les clients pour les missions taxis, c'est aussi les mêmes coordonées pour la destination du trajet 
    {x = 276.07, y = -591.82, z = 43.27},
